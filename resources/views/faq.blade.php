  ...
  <div class="row padding-faq">
    ...
    <div class="col-sm-7 col-xs-8 border mt-2 pt-2 pl-2 containerfaq">
      <div class="card pt-1" >
            ...
            <div class="card pt-2" >
              <div class="card-body" >
                <h3 class="card-title titlefaq" id="solicitarent">¿En qué consisten los Días Verdes?</h3>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h3 class="card-title titlefaq" id="recibire">Si el día Verde no me va bien, ¿Puedo solicitar la entrega un día distinto?</h3>
            ...
            <div class="card pt-2" id="diferencias">
              <div class="card-body">
            ...
            <section>
              ...
              <div class="card-body" id="">
                  <section id="whatsapp">
                <h3 class="card-title titlefaq" id="ped" >He hecho un pedido y no estoy seguro de cuantos litros van a caber en mi depósito, ¿Qué pasa si al final no caben?</h3>
