...
<div class="row bg-faq pt-1 pb-1 fixed-top4">
  ...
  <div class="col-sm-3 col-xs-9 pt-2 ml-7 ocultar-mobile">
    <select class="form-control mlmov-4  ">                        
            ...
            <option >¿En qué consisten los Días Verdes?</option>
  ...
  <div class="row padding-faq">
    ...
    <div class="col-sm-7 col-xs-8 border mt-2 pt-2 pl-2 containerfaq">
      <div class="card pt-1" >
              <div class="card-body" >
                 <section >
                     <h3 class="card-title titlefaq"><label>¿Que son los días Verdes?</label></h3>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h3 class="card-title titlefaq">¿Cómo solicito la entrega de mi pedido para un día Verde?</h3>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h3 class="card-title titlefaq">¿Cómo sé cuál es el Día Verde en mi Comunidad Autónoma?</h3>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h3 class="card-title titlefaq">¿Cuándo recibiré mi pedido de gasoil calefacción si lo pido hoy?</h3>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h3 class="card-title titlefaq">¿Puedo hacer un pedido de Gasoil Calefacción urgente?</h3>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h3 class="card-title titlefaq">¿Qué formas de pago hay y cuando lo hago efectivo?</h3>
