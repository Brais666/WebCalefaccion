                ...
                <div class="col-md-5 margin2">
                    <div class="width-texto card ml">
                      <div class="card-body">
                        ...
                        <h5 class="line-titular2 card-text"><a href="#">Fuertes lluvias, temperaturas descendiendo, niebla, nieve. Estas son posibles adversidades meteorológicas que nos podemos encontrar...</a>
                        </h5>
                      </div>
                    </div>
                </div>
            ...
            <div class="width-texto card ml">
              <div class="card-body">
                ...
                <h3 class="line-titular card-text">&#161;An&iacute;mate a seguirnos y no te pierdas todas las novedades que te hemos preparado!
                  ...
                  <a class="alinear-boton-compra" target="_blank"  rel="noopener noreferrer" onclick="myFunction()"  href="https://calefaccion.store/welcome"><p class="toggle-compra click-me btn" id=" leermenos1">Hacer mi pedido de gas&oacute;leo de calefac&oacute;n</p></a> 
