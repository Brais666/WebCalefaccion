	...
	<div class="row pb-13">
		...
		<div class="col-sm-7 col-xs-8 border mt-2 pt-2 pl-2 containerfaq">
			<div class="card pt-1" >
              <div class="card-body" >
                 <section id="diasv">
                     <h5 class="card-title titlefaq">¿Qué es la promoción 10 euros de descuento por tu cumpleaños?</h5>
            ...
            <div class="card pt-2" >
              <div class="card-body" id="diasven">
                <h5 class="card-title titlefaq">¿Qué sucede si mi cumpleaños es en Julio?</h5>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h5 class="card-title titlefaq">Aún no soy cliente de gasoleodecalefaccion.com ¿Puedo participar en la promoción?</h5>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h5 class="card-title titlefaq">Términos y condiciones de la promoción 10€ dto. por cumpleaños</h5>
