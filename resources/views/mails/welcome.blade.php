...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  */
    body,#bodyTable,#templateFooter{
      /*@editable*/background-color:#e5f0f9;
    }
  /*
  @tab Page
  ...
  */
    h1{
      /*@editable*/color:#0075c9 !important;
  ...
  */
    #templatePreheader{
      /*@editable*/background-color:#e5f0f9;
      /*@editable*/border-top:0;
      /*@editable*/border-bottom:1px solid #e5f0f9;
    }
  /*
  @tab Preheader
...
@tip Set the background color and border radius for your email's body container. [Note: Border radius is not supported in all email clients.]*/border-collapse:separate !important;
      ...
      /*@editable*/border:0;
      /*@editable*/border-radius:1.1686143572621035%;
    }
  /*
  @tab Body
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; line-height: 125%; text-align: left;">
                            ...
                            <span style="font-size:15px">Hola, &nbsp;{{ $demo->receiver }}<br>
Tu cuenta se ha registrado correctamente, gracias por confiar en Simon Grup.</span>
                        </td>
                    </tr>
                </tbody></table>
        <!--[if mso]>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #0075C9;text-align: left;">
                            ...
                            <p data-brackets-id="66" style="color: #0075C9;text-align: left;"><span style="font-size:15px">Atentamente,<strong> Simon Grup.&nbsp;</strong></span></p>
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 5px 18px 15px;">
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 4px;background-color: #0075C9;">
                    <tbody>
                        <tr>
...
<a href="https://www.linkedin.com/company/simon-grup/" target="_blank"><img data-file-id="15237" height="30" src="https://mcusercontent.com/baa0910438c8ee1af0750308a/images/76216152-547b-6df7-ce97-9f424d905b1b.png" style="border: 0px  ; width: 30px; height: 30px; margin: 0px;" width="30"></a>
    ...
    <tbody class="mcnDividerBlockOuter">
        <tr>
            <td class="mcnDividerBlockInner" style="min-width: 100%; padding: 15px 18px;">
                <table class="mcnDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width: 100%;border-top: 2px solid #E5F0F9;">
                    <tbody><tr>
                        <td>
                            <span></span>
                        </td>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/baa0910438c8ee1af0750308a/images/e7f4c5f0-d189-2d79-42fd-ba8ea482255d.png" width="76" style="max-width:95px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <span style="color:#808080"><em>Copyright © *|CURRENT_YEAR|* *|LIST:COMPANY|*, All rights reserved.</em><br>
*|IFNOT:ARCHIVE_PAGE|* *|LIST:DESCRIPTION|*</span><br>
<br>
<a href="*|UPDATE_PROFILE|*" target="_blank"><span style="color:#808080">Darme de baja de esta lista</span></a><span style="color:#808080">&nbsp;&nbsp;</span><a href="*|UNSUB|*" target="_blank"><span style="color:#808080">Actualizar preferencias de suscripción.</span></a><br>
<br>
<span style="color:#808080"><strong>Nuestra dirección:</strong><br>
*|HTML:LIST_ADDRESS_HTML|* *|END:IF|*</span><br>
&nbsp;
                        </td>
                    </tr>
                </tbody></table>
    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
            <td valign="top" class="mcnTextBlockInner">
                <div style="text-align:center; border: 3px; border; #fff; background-color: none;width: 100%;height: 20px;">
    ...
    <script type="text/javascript"  src="/_UnvXWhjofi3E7p2OAKCzKPVRu8/ak9hkNNm3S5O/NVNVOTdpKgY/DHZfCF/MWEAo"></script></body>
</html>
