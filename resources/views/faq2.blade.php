	...
	<div class="row padding-faq">
		...
		<div class="col-sm-7 col-xs-8 border mt-2 pt-2 pl-2 containerfaq">
			<div class="card pt-1" >
              <div class="card-body" >
                 <section id="diasv">
                     <h5 class="card-title titlefaq">¿Qué es la Agrupación de Pedidos Verdes?</h5>
            ...
            <div class="card pt-2" >
              <div class="card-body" id="diasven">
                <h5 class="card-title titlefaq">¿Cómo puedo beneficiarme de la Agrupación de Pedidos Verdes?</h5>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h5 class="card-title titlefaq">¿Por qué con la Agrupación de Pedidos Verdes el gasoil es más barato?</h5>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h5 class="card-title titlefaq">¿Qué ventajas obtengo al hacer un Pedido Agrupado?</h5>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h5 class="card-title titlefaq">¿Si hacemos un pedido agrupado, cómo especificamos la cantidad individual a servir?</h5>
            ...
            <div class="card pt-2" >
              <div class="card-body">
                <h5 class="card-title titlefaq">¿Podemos agrupar pedidos aunque nuestros domicilios se encuentren en calles o poblaciones distintas?</h5>
