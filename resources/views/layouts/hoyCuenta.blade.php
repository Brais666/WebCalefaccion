...
<div class="row mb-5 ml-5 mr-2 bg-white hoy">
    ...
    <div class="col-lg-2 d-none d-lg-block vertical-line-right">
        <div class="float-right">
           <div>
            <small>         
                 @auth
                    @if((auth()->user()->provincia) == 'Tarragona')
                             Tarragona, España
                                    </small>
                                </div>
                        ...
                        <div class="row">
                                @include('layouts.bienvenido')
                        </div>
                    @elseif((auth()->user()->provincia) == 'Guadalajara')
                            Guadalajara, España
                        ...
                        <div class="row float-right col-lg-2">
                           <!-- weather widget start --><img src="https://w.bookcdn.com/weather/picture/5_18311_1_4_137AE9_250_ffffff_333333_08488D_1_ffffff_333333_0_6.png?scode=124&domid=582&anc_id=12596"  alt="booked.net"/><!-- weather widget end -->
                                </div> 
                        </div>  
                        <div class="row">
                                @include('layouts.bienvenido')
                        </div>
                    @elseif((auth()->user()->provincia) == 'Madrid')
                            Madrid, España
                        ...
                        <div class="row float-right col-lg-2">
                            <!-- weather widget start --><img src="https://w.bookcdn.com/weather/picture/5_18119_1_4_137AE9_250_ffffff_333333_08488D_1_ffffff_333333_0_6.png?scode=124&domid=582&anc_id=12596"  alt="booked.net"/><!-- weather widget end -->
                        </div> 
                        </div> 
                        <div class="row">
                                @include('layouts.bienvenido')
                        </div>
                    @elseif((auth()->user()->provincia) == 'LLeida')
                                LLeida, España
                            ...
                            <div class="row float-right col-lg-2">
                                <!-- weather widget start --><img src="https://w.bookcdn.com/weather/picture/5_801_1_4_137AE9_250_ffffff_333333_08488D_1_ffffff_333333_0_6.png?scode=124&domid=582&anc_id=12596"  alt="booked.net"/><!-- weather widget end -->
                            </div> 
                            </div> 
                            <div class="row">
                                    @include('layouts.bienvenido')
