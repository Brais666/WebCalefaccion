...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Consulta en cualquier momento el precio de gasoil calefacción introduciendo tu población y la cantidad que necesites, comprueba el día de entrega y haz tu pedido.">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-76236532-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-76236532-1');
</script>
               ...
               <div class="form-group text-center">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="col-md-6 col-sm-5 col-xs-12 pbmov-2 text-left">
                          ...
                          <input type="text" class="searchty input col-sm-12" id="poblacion" name="poblacion" placeholder="{{$pobl}}">
                        </div>
