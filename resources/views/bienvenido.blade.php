        ...
        <div class="row pt-2 border ">
          ...
          <div class="col-sm-6 vertical-line">
            ...
            <div class="row pedido text-center">
              ...
              @else
              <button type="submit" class="btn buttonfinan mlmov-1" disabled data-toggle="tooltip" data-placement="top" title="Es necesario loguearse o registrarse para activar esta función"><a href="{{url('pedido?financiado=true')}} " style="color:white;" id="pedbtn">Hacer pedido financiado</a></button>
              @endif
            </div>
          </div>
