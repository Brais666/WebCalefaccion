...
<div class="container">
	<div class="border mt-2 pt-7 pb-2 containercook containerinfo">
		...
		<p class=" quienes-politica quienes cont">En cumplimiento de la Ley 34/2002 de 11 de julio de Servicios de la Sociedad de la Información y de Comercio Electrónico (LSSICE), te informamos de que este sitio web <b>gasóleodecalefacción.com </b>y <b>Laravel</b> utiliza cookies.</p>	
		<p class=" quienes-politica quienes">La LSSICE se aplica a cualquier clase de archivo o dispositivo que se descargue en el equipo terminal de un usuario con el fin de almacenar datos que podrán ser actualizados y recuperados por la entidad responsable de su instalación. Una cookie es uno de esos archivos de uso generalizado a los que, denominaremos genéricamente como cookies.</p>
		<p class=" quienes-politica quienes">Las cookies (en castellano, galletas) son pequeños ficheros de texto enviados a un navegador desde un servidor web para registrar actividad del usuario en un sitio web de modo que se pueda recuperar esa información con posterioridad durante la navegación por las diferentes páginas que estén conectadas al servidor que se las instaló.
		Las cookies suelen almacenar información de carácter técnico, preferencias personales, personalización de contenidos, estadísticas de uso, enlaces a redes sociales, acceso a cuentas de usuario, etc.</p>
		...
		<p class=" quienes-politica quienes">En el caso de que las cookies sean instaladas desde un equipo o dominio gestionado por el propio editor pero la información que se recoja mediante estas sea gestionada por un tercero, no son consideradas cookies propias.</p>
