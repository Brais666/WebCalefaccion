...
<body>  
    ...
    <form method="post" action="{{ route('productos.update',$producto->id) }}" >
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="txtId" placeholder="Id" name="txtId" value="{{ $producto->id }}">
        </div>
        <div class="form-group">
            <label for="txtNombre">Nombre:</label>
            <input type="text" class="form-control" id="txtNombre" placeholder="Introducir nombre" name="txtNombre" value="{{ $producto->nombre }}">
        </div>
        <div class="form-group">
            <label for="txtPvp">Pvp:</label>
            <textarea class="form-control" id="txtPvp" name="txtPvp" placeholder="Introducir pvp">{{ $producto->pvp }}</textarea>
        </div>
        <div class="form-group">
            <label for="txtAddress">Rango:</label>
            <textarea class="form-control" id="txtRang" name="txtRang" placeholder="Introducir rango">{{ $producto->rang }}</textarea>
        </div>
        <div class="form-group">
            <label for="txtEmpresa">Empresa:</label>
            <textarea class="form-control" id="txtEmpresa" name="txtEmpresa" placeholder="Introducir empresa">{{ $producto->empresa }}</textarea>
        </div>
