<!DOCTYPE html>
  ...
  <head>
    ...
    <link href="https://unpkg.com/browse/bootstrap-table@1.13.4/dist/bootstrap-table.min.css" rel="stylesheet">
           ...
           @include('layouts.hoy')
            ...
            <div class="row">
              ...
              <section>
                ...
                @include('Catalunya.clientes.containerClientes')
</body>
<script src="../public/js/core/jquery.3.2.1.min.js" type="text/javascript"></script>
  ...
  <script src="https://unpkg.com/browse/bootstrap-table@1.13.4/dist/bootstrap-table.min.js"></script>
</html>