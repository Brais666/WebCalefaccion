   ...
   <nav aria-label="breadcrumb" class="w-25">
     ...
     <section class="bg-grey">
          <div>
            ...
            {{$usuario->name}}           
                    <form class="p-4 ml-2 mt-5"  action="{{route('cliente.update')}}" method ="POST">
                  		...
                  		<div class="row p-2 mb-5">
								...
								<div class="form-group w-50 ml-5">
								    <div class="input-group">
							          ...
							          <input type="text" class="form-control" id="Apellidos" aria-describedby="emailHelp" placeholder="{{$usuario->apellidos}}">
							        </div>
								</div>							
								<div class="form-group w-50 w-50 ml-1">
								    <div class="input-group">
							          <div class="input-group-text font-weight-bold">Dirección</div>
							          <input type="text" class="form-control" id="Dirección" aria-describedby="emailHelp" placeholder="{{$usuario->address}}">
							        </div>
								</div>
								<div class="form-group w-25 ml-4">
								    <div class="input-group">
							          <div class="input-group-text font-weight-bold">Localidad</div>
							          <input type="text" class="form-control" id="Localidad" aria-describedby="emailHelp" placeholder="{{$usuario->localidad}}">
							        </div>
								</div>
								<div class="form-group w-25 ml-1">
								    <div class="input-group">
							          <div class="input-group-text font-weight-bold">Provincia</div>
							          <input type="text" class="form-control" id="Provincia" aria-describedby="emailHelp" placeholder="{{$usuario->localidad}}">
							        </div>
								</div>
								<div class="form-group w-25 ml-3">
								    <div class="input-group">
							          <div class="input-group-text font-weight-bold">C.P.</div>
							          <input type="text" class="form-control" id="C.P." aria-describedby="emailHelp" placeholder="{{$usuario->CP}}">
							        </div>
								</div>
								<div class="form-group w-25 ml-3">
								    <div class="input-group">
							          <div class="input-group-text font-weight-bold"><i class="fas fa-phone"></i></div>
							          <input type="text" class="form-control" id="telefono" aria-describedby="emailHelp" placeholder="{{$usuario->telefono}}">
							        </div>
								</div>
